...
EchoLocal is a **100% offline**, privacy-first Retrieval-Augmented Generation (RAG) assistant. It allows you to query your private documents locally without sending any data to cloud APIs.
